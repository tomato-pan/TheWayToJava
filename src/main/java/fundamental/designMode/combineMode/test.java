...
import fundamental.designMode.combineMode.model.vo.TreeNodeLink;
import fundamental.designMode.combineMode.model.vo.TreeRoot;
import fundamental.designMode.combineMode.service.engine.IEngine;
import fundamental.designMode.combineMode.service.engine.impl.TreeEngineHandle;
...
public class test {
    ...
    public static void test_EngineController() {
        EngineController engineController = new EngineController();
        String process = engineController.process("Oli09pLkdjh", "man", 29);
        System.out.println("测试结果："+ process);

    }
    public static void test_EEE(){
        // 节点：1
